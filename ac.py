...
browser = webdriver.Chrome(executable_path =ChromeDriverManager().install(), options=options, desired_capabilities=capabilities)
...
copy_button = browser.find_element(By.XPATH, """//*[@id="DontUseWEBuseAPI"]""")
